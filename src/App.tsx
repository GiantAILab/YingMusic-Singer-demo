...
const PAPER_INFO = {
  title: "Singing Voice Synthesis: A Comprehensive Evaluation of Neural Models",
  authors: ["John Doe", "Jane Smith", "Alice Johnson"],
  abstract: "Singing voice synthesis (SVS) has seen significant progress with the advent of deep learning. This paper provides a side-by-side comparison of various state-of-the-art neural SVS models. We evaluate these models on a diverse set of songs, focusing on melody accuracy, lyrical clarity, and overall naturalness. Our results demonstrate that while current models achieve high performance, there are still challenges in capturing the nuances of expressive singing.",
  links: [
