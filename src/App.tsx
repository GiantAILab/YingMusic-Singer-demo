...
const PAPER_INFO = {
  ...
  links: [
    ...
    { label: "Code", url: "https://github.com/GiantAILab/YingMusic-Singer-demo", icon: (
    ...
    { label: "Hugging Face", url: "https://huggingface.co/GiantAI/YingMusic-Singer", icon: (
      <span className="text-lg">🤗</span>
    )},
    { label: "ModelScope", url: "https://modelscope.cn/models/GiantAI/YingMusic-Singer", icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2L2 12l10 10 10-10L12 2zM4.4 12L12 4.4l7.6 7.6L12 19.6 4.4 12z" />
      </svg>
    )}
  ]
};
